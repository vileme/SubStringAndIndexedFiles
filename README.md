Ассинхронное приложение для получения и индексирования списка файлов,содержащих данную строку.А также быстрого пересчета в слуxае изменения какой-либо директории или файла.Qt ui
-------------------------------------------------------
